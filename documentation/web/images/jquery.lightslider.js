...
=========================================================/**/
;
(function(jQuery_1_9_1, undefined) {
    "use strict";
    ...
    $.fn.lightSlider = function(options) {
        ...
        var plugin = {};
        var settings = jQuery_1_9_1.extend(true, {}, defaults, options);
        var settingsTemp = {};
        var $el = this;
        plugin.$el = this;
        ...
        var $children = $el.children(),
            windowW = jQuery_1_9_1(window).width(),
            breakpoint = null,
            resposiveObj = null,
            length = 0,
            w = 0,
        ...
        plugin = {
            ...
            keyPress: function() {
                if (settings.keyPress === true) {
                    jQuery_1_9_1(document).bind('keyup', function(e) {
                        if (e.keyCode === 37) {
                            $el.goToPrevSlide();
            ...
            pager: function() {
				...
				//console.log ( "MAR" +  settings.thumbItem +" " +  settings.thumbMargin +" "+ elSize );
                    ...
                    for (i = 0; i < maxSlide; i++) {
						...
						var imgCd = $children.eq(i * settings.slideMove).attr('data-code');
						var imgName = $children.eq(i * settings.slideMove).attr('data-title');
						var imageType = $children.eq(i * settings.slideMove).attr('data-media');
						var bdgFlag = $children.eq(i * settings.slideMove).attr('data-bdg');
                        if (settings.gallery === true) {
                            ...
                            pagers += '<li  style="width:100%;' + property + ':' + thumbWidth + 'px;' + gutter + ':' + settings.thumbMargin + 'px" data-media="'+imageType+'" data-code="'+imgCd+'" data-title="'+imgName+'" data-bdg="'+bdgFlag+'"><a href="javascript:void(0)" class='+ imageType +'><img src="' + thumb + '" /><span class="icon"></span></a><span>'+imgName+'</span></li>';
                        } else {
                  ...
                  // jQuery_1_9_1(".lSPager").on('click','li', function(){
				  jQuery_1_9_1(".lSPager").delegate("li", "click", function() {
            ...
            //Custom code for Thumbnails starts
            thumbmove: function(ob, v) {
                if (settings.rtl === true) {
                    v = -v;
                }
                if (this.doCss()) {
            ...
            slideOnlyThumb: function() {
                ...
                var thumbSlide = thumbScene * ((thumbWidth + settings.thumbMargin)) - (position);
                ...
                this.thumbmove($pager, thumbSlide);
            },
            
          //Custom code for Thumbnails ends
            fade: function() {
        ...
        //custom code for THumbnail slider starts
        $el.goToNextThumbSlide = function(s, t) {
        	thumbScene = s;
            var nextI = true;
            if (settings.mode === 'slide') {
                var _slideValue = thumbScene * ((slideWidth + settings.slideMargin) * settings.slideMove);
                var nextI = _slideValue < w - elSize - settings.slideMargin;
            }
            if (((thumbScene * settings.slideMove) < length - settings.slideMove) && nextI) {
                if (settings.gallery === true) {
                    plugin.slideOnlyThumb();
                }
            }
           };
           $el.getCurrentThumbSlideCount = function() {
               return thumbScene + 1;
           }; 
          //custom code for THumbnail slider starts  
        return this;
